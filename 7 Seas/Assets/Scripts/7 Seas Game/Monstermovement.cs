...
public class Monstermovement : MonoBehaviour
{
    ...
    private List<string> attackAnims = new List<string>();
    ...
    void Update()
    {
        ...
        if (attackAnims.Count < 4)
        {
            attackAnims.Add("Attack1");
            attackAnims.Add("Attack2");
            attackAnims.Add("Attack3");
            attackAnims.Add("Attack4");
            attackAnims.Add("Attack5");
        }
        ...
        if(health<=0 && !died)
        {
            ...
            anim.Play("Death");
            monsterSound.PlayOneShot(sounds[4]);
            ...
            if (movingForward)
            {
                if (!anim.isPlaying)
                {
                    ...
                    if (x >= 2)
                    {
                        ...
                        monsterSound.PlayOneShot(sounds[0], 0.8f);
                    }
                }
            ...
            else if (attacking)
            {
                ...
                else
                {
                    if (!anim.IsPlaying("Attack1"))
                    {
                        ...
                        anim.Play(attackAnims[num]);

                        monsterSound.PlayOneShot(sounds[1], 0.8f);
            ...
            else if (standing)
            {
                ...
                else
                {
                    if (!anim.IsPlaying("Stand"))
                    {
                        ...
                        monsterSound.PlayOneShot(sounds[3], 0.8f);
    ...
    public void MonsterHit()
    {
        ...
        monsterSound.PlayOneShot(sounds[2], 0.8f);
