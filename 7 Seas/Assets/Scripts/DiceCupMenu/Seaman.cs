...
public class Seaman : MonoBehaviour
{
    public static string cupName = "seaman";
    ...
    {
        int lineNum = 0;
        foreach (string i in File.ReadLines(Application.persistentDataPath + "/Seaman.txt"))
        {
    ...
    {
        File.WriteAllText(Application.persistentDataPath+"/Seaman.txt",toString());
    }
}
