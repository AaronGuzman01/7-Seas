...
public class Swabie : MonoBehaviour
{
    public static string cupName = "swabie";
    ...
    {
        int lineNum = 0;
        foreach (string i in File.ReadLines(Application.persistentDataPath + "/Swabie.txt"))
        {
    ...
    {
        File.WriteAllText(Application.persistentDataPath + "/Swabie.txt", toString());
    }
}
